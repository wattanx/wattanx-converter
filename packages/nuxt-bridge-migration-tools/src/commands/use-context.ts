...
import useContext from "../transformations/use-context";
...
export const command = "use-context [targetFilePaths...]";
export const desc = "Convert `useContext()` to `useNuxtApp()`.";
...
export const handler = async (argv: Arguments<Options>): Promise<void> => {
  ...
  executeTransform(targetFiles, useContext);
};
